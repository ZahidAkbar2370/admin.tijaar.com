...
@section('title', 'Edit: Shipping Info')
...
<div class="w-full min-w-0">
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Edit: Shipping Info</h1>
        <p class="text-gray-500 mt-1">Update the Shipping Info page: hero, last updated date, numbered sections (table below), and footer. Use the table to add, edit, delete, or reorder sections. Content uses a rich text editor.</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.pages.update', $page) }}" id="shipping-form" class="space-y-8">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $page->title) }}" required placeholder="Shipping Info" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Hero title</label>
                    <input type="text" name="banner_title" value="{{ old('banner_title', $page->banner_title ?? 'Shipping Information') }}" placeholder="Shipping Information" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary" />
                </div>
                <div>
        ...
        @include('admin.pages.partials.sections-table', [
            ...
            'sections' => $sections,
            'prefix' => 'shipping',
            'sectionsTitle' => 'Shipping Info sections',
        ])
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="footer_contact_text" value="{{ old('footer_contact_text', $footerContact) }}" placeholder="Questions about shipping? Contact us." class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm" />
                </div>
                <div>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ url('shipping') }}" target="_blank" rel="noopener" class="ml-auto text-sm text-primary hover:underline">View Shipping Info page on site →</a>
        </div>
    </form>
</div>

@include('admin.pages.partials.section-modal', ['page' => $page, 'prefix' => 'shipping'])
@endsection
