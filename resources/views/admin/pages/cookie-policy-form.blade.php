...
<div class="w-full min-w-0">
    <div class="mb-8">
        ...
        <p class="text-gray-500 mt-1">Update the Cookie Policy page: hero, last updated date, numbered sections (table below), and footer. Use the table to add, edit, delete, or reorder sections. Content uses a rich text editor.</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.pages.update', $page) }}" id="cookie-policy-form" class="space-y-8">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $page->title) }}" required placeholder="Cookie Policy" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Hero title</label>
                    <input type="text" name="banner_title" value="{{ old('banner_title', $page->banner_title ?? 'Cookie Policy') }}" placeholder="Cookie Policy" class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary" />
                </div>
                <div>
        ...
        @include('admin.pages.partials.sections-table', [
            ...
            'sectionsTitle' => 'Cookie Policy sections',
        ])
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="footer_contact_text" value="{{ old('footer_contact_text', $footerContact) }}" placeholder="If you have questions about our use of cookies, please contact us." class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm" />
                </div>
                <div>
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ url('cookie-policy') }}" target="_blank" rel="noopener" class="ml-auto text-sm text-primary hover:underline">View Cookie Policy page on site →</a>
        </div>
    </form>
</div>

@include('admin.pages.partials.section-modal', ['page' => $page, 'prefix' => 'cookie-policy'])
@endsection
